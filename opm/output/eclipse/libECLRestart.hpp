...
public:
     ...
     size_t size() const {
//         return size_t ( ::Opm::RestartIO::ecl_kw_get_size( this->m_kw ) );
...
template<>
//inline const char* ::Opm::RestartIO::EclKW_ref< const char* >::at( size_t i ) const {
...
#if 0
#define ECL_KW_GET_TYPED_PTR_HEADER(type) type * ecl_kw_get_ ## type ## _ptr(const ::Opm::RestartIO::ecl_kw_type *)
...
#if 0
#define ECL_KW_IGET_TYPED_HEADER(type) type ecl_kw_iget_ ## type(const ::Opm::RestartIO::ecl_kw_type * , int)
