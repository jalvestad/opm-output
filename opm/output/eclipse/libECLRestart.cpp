...
// jal - define function to replace define ECL_INT
//#if 0
...
//static void ecl_kw_iset_static(::Opm::RestartIO::ecl_kw_type *ecl_kw , int i , const void *iptr) {
void ecl_kw_iset_static(::Opm::RestartIO::ecl_kw_type *ecl_kw , int i , const void *iptr) {
  ...
  //static void ecl_kw_assert_index(const ::Opm::RestartIO::ecl_kw_type *ecl_kw , int index, const char *caller) {
...
//static void * ecl_kw_iget_ptr_static(const ::Opm::RestartIO::ecl_kw_type *ecl_kw , int i) {
...
//static void ecl_kw_iget_static(const ::Opm::RestartIO::ecl_kw_type *ecl_kw , int i , void *iptr) {
...
ctype * ecl_kw_get_ ## ctype ## _ptr(const ::Opm::RestartIO::ecl_kw_type * ecl_kw) {                                                  \
...
ctype ecl_kw_iget_ ## ctype(const ::Opm::RestartIO::ecl_kw_type * ecl_kw, int i) {                                            \
  ctype value;                                                                                              \
  if (::Opm::RestartIO::ecl_kw_get_type(ecl_kw) != ECL_TYPE)                                                                  \
    util_abort("%s: Keyword: %s is wrong type - aborting \n",__func__ , ::Opm::RestartIO::ecl_kw_get_header8(ecl_kw));        \
...
void ecl_kw_iset_ ## ctype(::Opm::RestartIO::ecl_kw_type * ecl_kw, int i, ctype value) {                                      \
  if (::Opm::RestartIO::ecl_kw_get_type(ecl_kw) != ECL_TYPE)                                                                  \
    util_abort("%s: Keyword: %s is wrong type - aborting \n",__func__ , ::Opm::RestartIO::ecl_kw_get_header8(ecl_kw));        \
...
void ecl_kw_scalar_set_ ## ctype( ::Opm::RestartIO::ecl_kw_type * ecl_kw , ctype value){  \
 if (::Opm::RestartIO::ecl_kw_get_type(ecl_kw) == ECL_TYPE) {                                    \
    ctype * data = static_cast<ctype *>(::Opm::RestartIO::ecl_kw_get_data_ref(ecl_kw));                         \
    int i;                                                              \
...
::Opm::RestartIO::ecl_rst_file_type * ecl_rst_file_open_write_seek( const char * filename , int report_step) {
  ...
  */
  ...
  {
#if 0    
    ::Opm::RestartIO::ecl_data_type ECL_INT;
    //ECL_INT.type = static_cast<ecl_type_enum>(ECL_INT_TYPE);
    //ECL_INT.element_size = static_cast<size_t>(sizeof(ECL_INT_TYPE));
    ::Opm::RestartIO::ecl_data_type * ecl_dat_ptr = &ECL_INT;
    ::Opm::RestartIO::ecl_type_enum ecl_it = ECL_INT_TYPE;
    ::Opm::RestartIO::ecl_type_enum * ptr_1 = &ecl_it;
    size_t size_elm  = sizeof(ECL_INT.element_size);
    size_t * ptr_2  = &size_elm;
    //std::cout << "Main - Before assign type" << std::endl;
    //std::cout << "ecl_dat_1.type: " << ECL_INT.type << std::endl;
    //std::cout << "ecl_dat_1.element_size: " << ECL_INT.element_size << std::endl;

    ecl_dat_ptr = ECL_INT_F(ptr_1, ptr_2);
    ECL_INT = *ecl_dat_ptr;
    
    
    ::Opm::RestartIO::ecl_kw_type * work_kw = ::Opm::RestartIO::ecl_kw_alloc_new("WORK-KW" , 0 , ECL_INT, NULL);    
#endif
    ...
    while (true) {
      ...
      if (::Opm::RestartIO::ecl_kw_name_equal( work_kw , SEQNUM_KW)) {
        ...
        //int file_step = ::Opm::RestartIO::ecl_kw_iget_int( work_kw , 0 );
...
double ecl_file_view_iget_restart_sim_days(const ::Opm::RestartIO::ecl_file_view_type * ecl_file_view , int seqnum_index) {
  ...
  if (seqnum_map != NULL) {
    ...
    //sim_days = ::Opm::RestartIO::ecl_kw_iget_double( doubhead_kw , DOUBHEAD_DAYS_INDEX);
...
static void ecl_rst_file_fwrite_SEQNUM( Opm::RestartIO::ecl_rst_file_type * rst_file , int seqnum ) {
  ::Opm::RestartIO::ecl_kw_type * seqnum_kw = ::Opm::RestartIO::ecl_kw_alloc( SEQNUM_KW , 1 , ECL_INT_2 );
  //Opm::RestartIO::ecl_kw_iset_int( seqnum_kw , 0 , seqnum );
  Opm::RestartIO::ecl_kw_iset_type<int>( seqnum_kw , ECL_INT_TYPE, 0 , seqnum );
...
static ::Opm::RestartIO::ecl_kw_type * ecl_rst_file_alloc_INTEHEAD( ::Opm::RestartIO::ecl_rst_file_type * rst_file,
  ...
  //::Opm::RestartIO::ecl_kw_scalar_set_int( intehead_kw , 0 );
  ::Opm::RestartIO::ecl_kw_scalar_set_type( intehead_kw , ECL_INT_TYPE, 0 );

  /*::Opm::RestartIO::ecl_kw_iset_int( intehead_kw , INTEHEAD_UNIT_INDEX    , rsthead->unit_system );
  ::Opm::RestartIO::ecl_kw_iset_int( intehead_kw , INTEHEAD_NX_INDEX      , rsthead->nx);
  ::Opm::RestartIO::ecl_kw_iset_int( intehead_kw , INTEHEAD_NY_INDEX      , rsthead->ny);
  ::Opm::RestartIO::ecl_kw_iset_int( intehead_kw , INTEHEAD_NZ_INDEX      , rsthead->nz);
  ::Opm::RestartIO::ecl_kw_iset_int( intehead_kw , INTEHEAD_NACTIVE_INDEX , rsthead->nactive);
  ::Opm::RestartIO::ecl_kw_iset_int( intehead_kw , INTEHEAD_PHASE_INDEX   , rsthead->phase_sum );
  */
  ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_UNIT_INDEX    , rsthead->unit_system );
  ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_NX_INDEX      , rsthead->nx);
  ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_NY_INDEX      , rsthead->ny);
  ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_NZ_INDEX      , rsthead->nz);
  ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_NACTIVE_INDEX , rsthead->nactive);
  ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_PHASE_INDEX   , rsthead->phase_sum );
  /* All well properties are hardcoded to zero. */
  {
    ...
    ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_NWELLS_INDEX  , rsthead->nwells );
    ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_NCWMAX_INDEX  , rsthead->ncwmax );
    ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_NWGMAX_INDEX  , NWGMAX );
    ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_NGMAXZ_INDEX  , NGMAXZ );
    ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_NIWELZ_INDEX  , rsthead->niwelz );
    ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_NZWELZ_INDEX  , rsthead->nzwelz );
    ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_NICONZ_INDEX  , rsthead->niconz );
    ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_NIGRPZ_INDEX  , NIGRPZ );

    {
      ::Opm::RestartIO::ecl_util_set_date_values( rsthead->sim_time , &rsthead->day , &rsthead->month , &rsthead->year );
      ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_DAY_INDEX    , rsthead->day );
      ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_MONTH_INDEX  , rsthead->month );
      ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_YEAR_INDEX   , rsthead->year );
    }

    ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_IPROG_INDEX , simulator);
    ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_NSWLMX_INDEX  , NSWLMX );
    ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_NSEGMX_INDEX  , NSEGMX );
    ::Opm::RestartIO::ecl_kw_iset_type<int>( intehead_kw , ECL_INT_TYPE, INTEHEAD_NISEGZ_INDEX  , NISEGZ );
  }
  return intehead_kw;
}
...
static ::Opm::RestartIO::ecl_kw_type * ecl_rst_file_alloc_DOUBHEAD( ::Opm::RestartIO::ecl_rst_file_type * rst_file , double days) {
  ...
  //::Opm::RestartIO::ecl_kw_scalar_set_double( doubhead_kw , 0);
  ::Opm::RestartIO::ecl_kw_scalar_set_type( doubhead_kw , ECL_DOUBLE_TYPE, 0);
  //::Opm::RestartIO::ecl_kw_iset_double( doubhead_kw , DOUBHEAD_DAYS_INDEX , days );
  ::Opm::RestartIO::ecl_kw_iset_type<double>( doubhead_kw , ECL_DOUBLE_TYPE, DOUBHEAD_DAYS_INDEX , days );
...
::Opm::RestartIO::ecl_read_status_enum ecl_kw_fread_header(::Opm::RestartIO::ecl_kw_type *ecl_kw , fortio_type * fortio) {
  ...
  if (fmt_file) {
    ...
    //size = alias_cast<int>(&buffer[ECL_STRING8_LENGTH] );
